var testData = [
  {
    ...
    tests: [
      {
        props: { name: '"after each" hook for "[Scenario-1] Sanity"', time: 0 },
        snapshots: [
          {
            props: { name: "octoplay-1-ui-autoplay-modal-none-resume" },
            resolutions: [
              {
                size: "1568-1024",
                images: {
          ...
          {
            props: { name: "octoplay-1-ui-autoplay-modal-resume" },
            resolutions: [
              {
                size: "1568-1024",
                images: {
          ...
          {
            props: { name: "octoplay-2-ui-help-modal-none-resume" },
            resolutions: [
              {
                size: "1568-1024",
                images: {
          ...
          {
            props: { name: "octoplay-2-ui-help-modal-resume" },
            resolutions: [
              {
                size: "1568-1024",
                images: {
          ...
          {
            props: { name: "octoplay-3-ui-settings-modal-none-resume" },
            resolutions: [
              {
                size: "1568-1024",
                images: {
          ...
          {
            props: { name: "octoplay-3-ui-settings-modal-resume" },
            resolutions: [
              {
                size: "1568-1024",
                images: {
          ...
          {
            props: { name: "octoplay-4-ui-history-modal-empty-none-resume" },
            resolutions: [
              {
                size: "1568-1024",
                images: {
